...
class Robot : public frc::TimedRobot {
 public:
  ...
  bool  wait_for_button,  bottom_intake_in,  bottom_intake_out,
       climber_legs_up,  top_intake_in,  top_intake_out,  top_intake_stop,
       ...
       place_hatch_high, place_hatch_mid, place_hatch_low, place_cargo_high, place_cargo_mid, place_cargo_low, post_outtake_hatch,  post_outtake_cargo, climb_button, place_cargo_bay;
