...
const double Kp = 1.9;//0.15;//0.75; //0.0
const double Ki = 0.0006;//0.0015;//0.00085; 0.0009
...
const double ENC_CRUISE_ACC = 1000.0; //CRUISE_ACC * (1.0 / (2.0 * 3.14159)) * 4096.0 * 7.5 * (100.0); //ticks/100ms/sec = ticks/100sec
